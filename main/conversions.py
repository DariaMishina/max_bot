...
Два потока трекинга:
  1. Лендинг → бот: конверсии на лендинге прошиваются через JS (счётчик 107059457).
...
async def save_paywall_conversion(
    ...
    Args:
        ...
        paywall_source: Источник показа пейволла:
            ...
            - 'last_free_divination': только что использован последний бесплатный расклад
            - 'follow_up_limit': исчерпан лимит уточнений и нет гаданий
